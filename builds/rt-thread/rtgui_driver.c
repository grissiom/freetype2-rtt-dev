...
rtgui_font_t *rtgui_freetype2_font_create(const char *filename, int bold, int italic, rt_size_t size)
{
    FT_Error err = 0;
...
void rtgui_freetype2_font_destroy(rtgui_font_t *font)
{
    struct rtgui_freetype2_font *fft;
...
#include <finsh.h>
FINSH_FUNCTION_EXPORT_ALIAS(rtgui_freetype2_font_create, ftc, "create freetype font: name, bold, italic, size")
FINSH_FUNCTION_EXPORT_ALIAS(rtgui_freetype2_font_destroy, ftd, "destroy freetype font")
#endif
